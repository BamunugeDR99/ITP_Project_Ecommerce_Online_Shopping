...
export default function Add_items(props){
    ...
    function sendData(e){
        ...
        axios.post("http://localhost:8070/items/addItems",newItem).then(()=>{
          //custome message to the user
            document.getElementById("Submitstatus").innerHTML = "Item Added SuccessFully!";
    ...
    return(
        ...
        <br/><br/><br/>
        <h1 className = "headerName" id = "headerName">ADD YOUR ITEM</h1>
                ...
                <form onSubmit = {sendData}>
                    <div class="row">
                      <div class="col">
                        ...
                        <input type="text" id = "item_name" class="form-control" placeholder="Name of the item"
                         onChange= {
                            (e)=>{
                    ...
                    <div class="row">
                        <div class="col">
                          ...
                          <input type="text" id = "brand" class="form-control" placeholder="Item brand"
                           onChange= {
                            (e)=>{
                        ...
                        <div class="col">
                          ...
                          <input type="text" id = "model" class="form-control" placeholder="Item model"
                           onChange= {
                            (e)=>{
                   ...
                   <br/>
                      <div class="row">
                        <div class="col">
                          ...
                          <input type="text" id = "price" class="form-control" placeholder="Price of the item"
                           onChange= {
                            (e)=>{
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <textarea class="form-control" id = "description" rows="5" placeholder="Description about the item" 
                             onChange= {
                                (e)=>{
                        ...
                        <div class="col">
                            ...
                            <textarea class="form-control" id = "specifications" rows="5" placeholder="Item specifications" onChange= {
                                 (e)=>{
                      ...
                      <div class="col">
                        ...
                        <textarea class="form-control" rows="5" id = "wht" placeholder="Tell what inside the package ?"  onChange= {
                         (e)=>{
