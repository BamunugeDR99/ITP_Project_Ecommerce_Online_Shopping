...
export default function AllPackages(props) {
  ...
  function statusChange(id, index) {
    ...
    if (document.getElementById(index + "x").checked === false) {
      axios
        .get(
          "https://tech-scope-online.herokuapp.com/Packages/getPackage/" + id
        )
        .then((res) => {
          //let data = res.data;
          ...
          axios
            .put(
              "https://tech-scope-online.herokuapp.com/Packages/updatePackages/" +
                id,
              res.data
            )
            .then(() => {
  ...
  function filterContent(data, userSearch) {
    ...
    if (result !== null) {
      ...
      setPSearchAlert(
        "Ooops ! We don't have quite the thing you are looking for..."
      );
    ...
    <div className="OffersnPacks">
      ...
      <div className="container">
        <div>
          ...
          />
          <br></br>
          <p id="PackageSearchAlert" style={{ color: "red", fontSize: "26px" }}>
            {packSearchAlert}
          </p>
          <div className="row">
                ...
                <div className="col-sm-4">
                  <div className="card" style={{ width: "18rem" }}>
                    <div className="container-fluid" style={{ padding: "0px" }}>
                      <img
                        className="img-responsive center-block header1 rounded-top"
                        ...
                        <center>
                          ...
                          <label class="switch">
                            <input
                              type="checkbox"
                              id={index + "x"}
                              onChange={() => statusChange(item._id, index)}
                            />
