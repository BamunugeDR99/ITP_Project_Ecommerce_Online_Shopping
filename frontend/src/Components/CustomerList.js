...
export default function CustomerList(props) {
  ...
  function deleteCus(id) {
    axios
      ...
      .then((res) => {
        ...
        const afterDeleteCustomer = customer.filter(
  ...
  function filterCustomer(data, customerSearch) {
    let result = data.filter(
      (post) =>
        post.firstName.toLowerCase().includes(customerSearch.toLowerCase()) ||
        post.lastName.toLowerCase().includes(customerSearch.toLowerCase()) ||
        post.username.toLowerCase().includes(customerSearch.toLowerCase())
    );
    setCustomers(result);
    if (result != null) {
      setLoad(false);
    ...
    <div class="CustomerList">
      ...
      <div class="input-group" id="CusSerch">
        <input
          ...
          placeholder="Search by first name or last name or username...."
          aria-label="Search"
                ...
                <tr>
                  ...
                  <td data-label="Action">
                    <div>
                      ...
                      <button
                        class="btnremove"
                        onClick={() => deleteCus(customer._id)}
                      >
                        Remove
                      </button>
                    </div>
