...
export default function ItemsForSpecificSeller(props) {
    ...
    function getItems() {
      ...
      axios
        ...
        .then((res) => {
          ...
          setItems(res.data.filter((post)=> post.SellerID === SellerID));
  ...
  function handleSearch(e) {
    ...
    axios
      ...
      .then((res) => {
        ...
        //console.log(res.data);
        SellerID = props.match.params.id;
        let newItems = res.data.filter((post)=> post.SellerID === SellerID);
        filterContent(newItems, userSearch);
      })
      .catch((err) => {
        alert(err);
      });
