...
export default function SellerPassword(props) {
  ...
  useEffect(() => {
    function getorgSellers() {
      ...
      axios
        .get(
          "https://tech-scope-online.herokuapp.com/orgSeller/get/" + objectID
        )
        .then((res) => {
                    ...
                    <div className="card border border-dark rounded ">
                      ...
                      <div className="card-body">
                        <ul class="list-group list-group-flush">
                          <div class="shop">
                            <h4 class="mb-0" style={{ textAlign: "left" }}>
                              {orgSeller.companyname}
                            </h4>
                          </div>
                          <br></br>

                          <div class="shop">
                            <h6 class="mb-0" style={{ textAlign: "left" }}>
                              {orgSeller.mobile}
                            </h6>
                          </div>
                          <br></br>
                            ...
                            <form style={{ textAlign: "center" }}>
                              ...
                              <div class="inputsize">
                                ...
                                <button
                                  ...
                                  onClick={() => ChangePassword(orgSeller._id)}
                                >
                                  Change
                                </button>
                                <button
