    ...
    useEffect(() => {
        function getpaymentdetails() {
            ...
            axios.get("http://localhost:8070/paymentdetails/get").then((res) => {
                setpaymentdetails(res.data.filter((item) => item.ownerID === ownerID));
    ...
    function deleteCard(ID) {
        ...
        axios
            ...
            .then((res) => {
                ...
                const remainingCards = paymentdetails.filter(
                    (pack) => pack._id != ID
                );
    ...
    return (
        ...
        <div Class="ViewCard">
            <div class="container-fluid p-3 my-3">
                            ...
                            <div className="col-sm">
                                <div class="card p-3">
                                    ...
                                    <div class="float-right">
                                        ...
                                        <span style={{ marginRight: "150px", marginLeft: "80px" }}> <button id="" type="reset" class="btn btn-primary" onClick={() => { editCard(paymentdetails._id) }}>Edit</button></span>

                                        <span><button class="btn btn-danger " onClick={() => deleteCard(paymentdetails._id)}>Remove</button></span>
                                    </div>
                ...
                <div>
                <button type="button" class="btn btn-primary" onClick = {() =>addNewCard() }>Add a New Payment</button>
